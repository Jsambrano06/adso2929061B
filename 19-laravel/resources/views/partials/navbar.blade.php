<div class="navbar bg-black fixed top-0 left-0 text-white p-0 z-50">
    <div class="flex-1">
        <a href="{{ url('/') }}" class="btn btn-ghost text-xl">
            Larapets <svg xmlns="http://www.w3.org/2000/svg" class="size-7" fill="currentcolor" viewBox="0 0 256 256">
                <path
            ...
            @else
                <li>
                    <details>
                        ...
                        <ul class="bg-black/60 rounded-t-none m-0 text-white w-45 -ms-5 py-4">
